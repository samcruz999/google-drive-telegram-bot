class config:
    BOT_TOKEN = "5095698277:AAGapi6eZoLhLNBUBrmcg8iqm-Zk_PF-H9A"
    APP_ID = "9442548"
    API_HASH = "e5b0465366ece012d771a67dc2fb6ea3"
    DATABASE_URL = "postgres://apvrfckwemswvz:ab45a3e3a634229933d5a83faedd1d5e1c693d57e4a1714e0787638c45b67a15@ec2-3-89-214-80.compute-1.amazonaws.com:5432/da89frsgmeg0e9"
    SUDO_USERS = "829959269" # Sepearted by space.
    SUPPORT_CHAT_LINK = ""
    DOWNLOAD_DIRECTORY = "./downloads/"
    G_DRIVE_CLIENT_ID = "28916761587-hhfnljqn8dh9d7sn5lu0lp1hqvr8hegr.apps.googleusercontent.com"
    G_DRIVE_CLIENT_SECRET = "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"
...
class Messages:
    START_MSG = "**Hi there {}.**\n__I'm Cruz Drive Bot.You can use me to upload any file / video to Google Drive from direct link or Telegram Files.__\n__You can know more from /help.__"
